define([
  ...
  return declare([GraphicsLayer], {
    ...
    _clusterCreate: function (p) {
      //alert(JSON.stringify(p.attributes));
    ...
    _showCluster: function (c) {
      //alert(JSON.stringify(c.attributes));
      ...
      //alert(c.attributes.clusterCount.toString());
    ...
    _addSingles: function (singles) {
      ...
      arrayUtils.forEach(singles, function (p) {
        ...
        //alert(this._singleTemplate.content().innerHTML);
