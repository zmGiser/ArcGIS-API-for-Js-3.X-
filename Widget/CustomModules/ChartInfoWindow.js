define(["dojo/_base/declare", "esri/InfoWindowBase", "esri/domUtils", "esri/geometry/Point", "dojo/_base/lang", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-style", "dojo/_base/array"], function (e, d, c, h, a, i, b, f, g) {
    return e(d, {
        map: {},
        chart: "",
        chartPoint: "",
        ...
        constructor: function (j) {
            ...
            this.domNode = b.create("div", null, document.getElementById("map_root").parentNode);
        ...
        setMap: function (j) {
            ...
            this._eventConnections.push(j.on("extent-change", a.hitch(this, this.__onMapExtChg)));
            this._eventConnections.push(j.on("zoom-start", a.hitch(this, this.__onMapZmStart)));
        ...
        onMapZm: function (k) {
            var m = k.extent, o = k.zoomFactor, l = k.anchor;
        ...
        __onMapExtChg: function (j) {
            var l = j.extent, p = j.delta, o = j.levelChange;
            var m = this.map, n = this.mapCoords;
            if (n) {
